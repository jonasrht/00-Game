...
export default class Player extends Phaser.Physics.Arcade.Sprite {
  ...
  create(texture) {
    ...
    this.anims.create({
      key: "sword-ult",
      frames: this.anims.generateFrameNames("swordult", {
        prefix: "schwertanimation",
        start: 1,
        end: 7,
        zeroPad: 0,
        suffix: ".png",
    ...
    this.scene.anims.create({
      key: "sword-left",
      frames: this.anims.generateFrameNames("sword", {
        frames: ["schwert1.png", "schwert2.png"],
      }),
      frameRate: 6,
      repeat: 0,
    });
    this.scene.anims.create({
      key: "sword-up",
      frames: this.anims.generateFrameNames("sword", {
        frames: ["schwert3.png", "schwert7.png"],
      }),
      frameRate: 6,
      repeat: 0,
    });
    this.scene.anims.create({
      key: "sword-down",
      frames: this.anims.generateFrameNames("sword", {
        frames: ["schwert5.png", "schwert5.png"],
      }),
      frameRate: 6,
      repeat: 0,
    });
    this.scene.anims.create({
      key: "sword-right",
      frames: this.anims.generateFrameNames("sword", {
        frames: ["schwert4.png", "schwert6.png"],
      }),
      frameRate: 6,
      repeat: 0,
    });
...
class IdleState extends State {
  ...
  execute(scene, hero) {
    ...
    if (
      (left.isDown || right.isDown || up.isDown || down.isDown) &&
      hero.movement
    ) {
  ...
  enter(scene, hero) {
    ...
    switch (hero.direction) {
      case "up":
        ...
        break;
      case "down":
        this.swordanim = scene.add
          .sprite(hero.x, hero.y + 9)
          .play("sword-down");
        this.swordHitbox = scene.add.rectangle(hero.x, hero.y + 18, 20, 10);
        break;
      case "left":
        this.swordanim = scene.add
          .sprite(hero.x - 2, hero.y + 6)
          .play("sword-left");
